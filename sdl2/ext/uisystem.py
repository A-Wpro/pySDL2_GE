...
def _compose_checkbutton(obj,id_compo):
    ...
    code.
    """
    _compose_button(obj,id_compo)
    obj.uitype = CHECKBUTTON
    obj.checked = False


def _compose_textentry(obj,id_compo):
...
class UIFactory(object):
    ...
    def create_button(self, id_compo, **kwargs):
    ...
    def create_text_entry(self, id_compo, **kwargs):
